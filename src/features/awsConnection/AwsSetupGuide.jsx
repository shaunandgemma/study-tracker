...
import { useAwsConnection } from './useAwsConnection.js';
      ...
      <div className="rounded-3xl bg-gradient-to-r from-slate-900 via-indigo-950/50 to-slate-900 border border-slate-800 p-6 sm:p-8 backdrop-blur-xl relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-slate-400 font-semibold">Follow Along Verification</span>
          </div>
          ...
          <p className="text-sm text-slate-300 leading-relaxed max-w-3xl">
            Connect your AWS account via a restricted IAM Role to enable automated read-only verification of your AWS Follow Along work. Follow the step-by-step guide below to launch our pre-configured CloudFormation template.
          </p>
        </div>
      </div>
