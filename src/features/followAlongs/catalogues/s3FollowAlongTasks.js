/**
 * Amazon S3 Follow Along Tasks & Guided AWS Labs (SAA-C03)
...
export const S3_TASKS = [
  ...
  },
  {
    ...
    "whyItMatters": "This closes the S3 Follow Along set and helps you connect the guided tasks to exam decisions.",
    "values": [
      {
        "label": "AWS Region",
        "value": "eu-west-2"
